...
public class Message2 : MonoBehaviour {
	...
	void Start () {
        ...
        SetMessage("ゴーレム\n"
            ...
            + "ウ　ニ\n"
            + "\n"
            + "えっ、何で知ってるの？もしかして魔物が使える特殊能力みたい\n"
            + "なものですべて見られてたの？\n"
            + "ゴーレム\n"
            + "\n"
            + "少し違うが間違ってはいない。もともとゴーレムは一つ大きな岩からわかれて\n"
            + "できた魔物だ。森のゴーレムとは意識が共有している。\n"
            + "ゴーレム\n"
            + "\n"
            + "やつとお前の会話は聞こえていたのだ。お前が求める物があるかはわからんが\n"
            + "この先に強き人間がいるようだ。\n"
            + "ゴーレム\n"
            + "\n"
            + "そいつがなにか知っているかもしれんな。だが、分かっているだろうが\n"
            + "先に進むにはわしを倒してからだ。いつでも来い！\n"
        );
	}
