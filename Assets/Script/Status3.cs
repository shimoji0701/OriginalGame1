...
public class Status3 : MonoBehaviour {
    ...
    void Start () {
        ...
        BossPower = 1;
        BossHP = 600;
        chanCame = GameObject.Find("unitychan").GetComponent<ChangeCamera3>();
    ...
    public void EnemyAttack() {
        ...
        Invoke("Call3", 2.5f);
            ...
            if (BossHP > 0) {
                ...
                this.animator.SetBool("Skil2", false);
                Invoke("Damage", 1.5f);
                transform.position = new Vector3(-211.1f, 0f, 255.1f);
