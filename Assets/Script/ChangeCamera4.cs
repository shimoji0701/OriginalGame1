...
public class ChangeCamera4 : MonoBehaviour {
    //　メインカメラ
    ...
    void Start () {
        ...
        status = GameObject.Find("BattleHero").GetComponent<Status4>();
    }     
...
void OnTriggerStay(Collider col) {
        ...
        if(col.tag == "Boss") {
            ...
            fadein = true;
            GameObject.Find("unitychan").GetComponent<AudioSource>().Play();
            BHeroPos.transform.position = new Vector3(-211.1f, 0f, 225.1f);
    ...
    void Call3() {
        ...
        GameObject.Find("HPText").GetComponent<Text>().text = "" + Status4.HP;
        GameObject.Find("MPText").GetComponent<Text>().text = "" + Status4.MP;
        fadein = false;
        fadeout = false;
    }
}
